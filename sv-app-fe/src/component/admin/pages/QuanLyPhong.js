                                ...
                                <div className="container-xxl flex-grow-1 container-p-y">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-3">
                                            <h4 className="card-header" style={{ fontSize: "calc(1.2625rem + 0.15vw)" }}> Quản lý phòng </h4>
                                        </div>
                                        <div className="col-md-7">
                                            <div className="mb-3">
                                                <div className="demo-inline-spacing">
                                                    ...
                                                    > <AiIcons.AiFillPlusSquare /> Thêm phòng</button>
                                                    <button type="button" class="btn btn-info"
                                                        style={{
                                                            float: "right", display: "inline-block", fontWeight: "400"
                                                            , lineHeight: "1.53", textAlign: "center", verticalAlign: "middle", userSelect: "none"
                                                    ...
                                                    > <AiIcons.AiFillPlusSquare /> Thêm loại phòng</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
